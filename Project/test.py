...
rootDir = 'data/DVDcovers'					# The root directory of the dataset
...
fileList = sorted(os.listdir('data/DVDcovers'))
dirName = 'data/DVDcovers'
...
def dumpFeatures(rootDir):
    ...
    for fname in fileList:
        ...
        if not fname.startswith('.') and not fname.endswith('.gif'):
